...
run_benchmarking = False             # Run benchmarking comparisons (init, reg, corr_map)
benchmark_tag = None                # Set to a descriptive string or use datetime if set to None
...
demo_data_dir = demo_data_base + r"\TSeries-03062025-8sxAA091024M1-009_2_Planes_50_Frames"
output_base_raw = demo_data_base + r"\SUITE3D_TEST_OUTPUT"
job_name = "PARAMETER-TUNING-TSeries-03062025-8sxAA091024M1-009_2_Planes_50_Frames"
...
# [DEFAULT] = 20
gpu_reference_batch_size = 1
# number of files to use for the initial pass
# ~500 frames is a good rule of thumb
# we will just use 200 here for speed
n_init_files = 20   # NOTE: This now means how many frames/full volumes
